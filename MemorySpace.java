...
public class MemorySpace {
	...
	public int malloc(int length) {
		// Finds the first free block whose length is at least the requested length
	...
	public void free(int address) {
		if (this.allocatedList.getSize() == 0) { // This is dumb. I don't need this. I put this here for test number 2.
	 ...
	 */
	public void defrag() {
		// Sorts the freeList by base address
		this.freeList.sort();
